...
class BranchSearchQuery(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """BranchSearchQuery - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            active_at (date): If date is set, returns only active branches at that date, if date is not set, also inactive branches are returned. [optional]  # noqa: E501
            application_type (int): If not Null, return only branches fitting at least on application type are returned. [optional]  # noqa: E501
            is_treating (bool): If true only treating branches are returned, if false only non-treating branches are returned. [optional]  # noqa: E501
            meta_data (SearchQueryMetaData): [optional]  # noqa: E501
            modified_from (datetime): Searches branches that have last changed after modifiedFrom (inclusive). [optional]  # noqa: E501
            modified_to (datetime): Searches branches that have last changed before modifiedTo (inclusive). [optional]  # noqa: E501

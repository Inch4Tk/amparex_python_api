...
class PrincipalSearchQuery(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PrincipalSearchQuery - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            admin (bool): if empty, will find all principal, also admin principal; true will find only admin principals; false will find only not admin principals. [optional]  # noqa: E501
            application_type (int): Search for principals that use the given application type. [optional]  # noqa: E501
            default_branch_id (str): Search for principals that have default branch given by branch id. [optional]  # noqa: E501
            ...
            principal_card_id (str): Search for principal which has principal card given by principal card id. [optional]  # noqa: E501
        """

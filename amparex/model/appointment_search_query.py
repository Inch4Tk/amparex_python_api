...
class AppointmentSearchQuery(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """AppointmentSearchQuery - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            branch_id (str): appointments for specified branchID. [optional]  # noqa: E501
            customer_id (str): appointments for specified customerID. [optional]  # noqa: E501
            end_time (str): appointments that end before specified time (inclusive). [optional]  # noqa: E501
            from_date (date): appointments from specified date (inclusive). [optional]  # noqa: E501
            meta_data (SearchQueryMetaData): [optional]  # noqa: E501
            modified_from (datetime): Searches appointments that have last changed after modifiedFrom (inclusive). [optional]  # noqa: E501
            modified_to (datetime): Searches appointments that have last changed before modifiedTo (inclusive). [optional]  # noqa: E501
            order_by ([OrderBy]): Multiple order by criteria, use appointment/orderByFields to get possible values. Use \"ASC\" for ascending, \"DESC\" for descending order; default is \"ASC\". Maximum 3 order criteria are used.. [optional]  # noqa: E501
            resource_ids ([str]): appointments using specified resources (logically and). [optional]  # noqa: E501
            start_time (str): appointments that start after specified time (inclusive). [optional]  # noqa: E501
            status_id (str): appointments with specified status via PredefinedPropertyID. [optional]  # noqa: E501
            to_date (date): appointments to specified date (inclusive). [optional]  # noqa: E501
            treatment_id (str): appointments for specified treatment. [optional]  # noqa: E501
            type_id (str): appointments with specified type via PredefinedPropertyID. [optional]  # noqa: E501
        """

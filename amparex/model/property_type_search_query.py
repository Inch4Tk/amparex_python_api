...
class PropertyTypeSearchQuery(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PropertyTypeSearchQuery - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            categories ([str]): All categories are available with url ../properties/propertytypes/categories. [optional]  # noqa: E501
            hidden (bool): if true searches only for hidden property types, if false only not hidden property types are found, if empty all property types independent of hidden are found. [optional]  # noqa: E501
            meta_data (SearchQueryMetaData): [optional]  # noqa: E501
            modified_from (datetime): Searches property types that have last changed after modifiedFrom (inclusive). [optional]  # noqa: E501
            modified_to (datetime): Searches property types that have last changed before modifiedTo (inclusive). [optional]  # noqa: E501

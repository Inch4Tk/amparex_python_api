...
class CompanySearchQuery(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """CompanySearchQuery - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            for_use (bool): if true searches only for companies which are marked for use, if false all companies which are not marked for use are found, if empty all companies are found. [optional]  # noqa: E501
            meta_data (SearchQueryMetaData): [optional]  # noqa: E501
            modified_from (datetime): Searches companies that have last changed after modifiedFrom (inclusive). [optional]  # noqa: E501
            modified_to (datetime): Searches companies that have last changed before modifiedTo (inclusive). [optional]  # noqa: E501

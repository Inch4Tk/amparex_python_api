...
class VersionSearchQuery(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'build_time_from': (datetime,),  # noqa: E501
            'build_time_to': (datetime,),  # noqa: E501
            'main_version_id': (str,),  # noqa: E501
    ...
    attribute_map = {
        'build_time_from': 'buildTimeFrom',  # noqa: E501
        'build_time_to': 'buildTimeTo',  # noqa: E501
        'main_version_id': 'mainVersionID',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """VersionSearchQuery - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            build_time_from (datetime): Searches all version that are build after given timestamp. [optional]  # noqa: E501
            build_time_to (datetime): Searches all version that are build before given timestamp. [optional]  # noqa: E501
            main_version_id (str): Searches for all versions for the corresponding main version. [optional]  # noqa: E501
            meta_data (SearchQueryMetaData): [optional]  # noqa: E501
            number (str): Searches by using a specific release number. [optional]  # noqa: E501
            order_by ([OrderBy]): Multiple order by criteria, use version/orderByFields to get possible values. Use \"ASC\" for ascending, \"DESC\" for descending order; default is \"ASC\". Maximum 3 order criteria are used.. [optional]  # noqa: E501
            release (str): Searches by using major release. e.g. \"LTS-2020.4\". [optional]  # noqa: E501
            stable (bool): Searches for stable / unstable builds. [optional]  # noqa: E501
        """

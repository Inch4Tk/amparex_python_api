...
class ResourceSearchQuery(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ResourceSearchQuery - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            branch_id (str): resources for specified branchID. [optional]  # noqa: E501
            for_online_booking (bool): if true, only resources enabled for online booking are found. [optional]  # noqa: E501
            hidden (bool): if empty, will find all resources, also hidden; true will find only hidden resources; false will find only not hidden resources. [optional]  # noqa: E501
            meta_data (SearchQueryMetaData): [optional]  # noqa: E501
            modified_from (datetime): Searches resources that have last changed after modifiedFrom (inclusive). [optional]  # noqa: E501
            modified_to (datetime): Searches resources that have last changed before modifiedTo (inclusive). [optional]  # noqa: E501
            name (str): resources with specified name. [optional]  # noqa: E501
            staff_id (str): resources for specified staffID. [optional]  # noqa: E501
        """

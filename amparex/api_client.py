...
from amparex import rest
from amparex.configuration import Configuration
from amparex.exceptions import ApiTypeError, ApiValueError, ApiException
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.create_address_using_post  # this is an instance of the class Endpoint
        api_instance.create_address_using_post()  # this invokes api_instance.create_address_using_post.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.create_address_using_post.callable or self.callable in this class

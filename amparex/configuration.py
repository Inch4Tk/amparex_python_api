...
conf = amparex.Configuration(
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self._base_path = "http://trial.amparex.net:8078/amparex/webaxapi" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("amparex")
    ...
    def auth_settings(self):
        ...
        """
        auth = {}
        if 'security_token' in self.api_key:
            auth['security_token'] = {
                'type': 'api_key',
                'in': 'header',
                'key': 'Authorization',
    ...
    def get_host_settings(self):
        ...
        return [
            {
                'url': "//trial.amparex.net:8078/amparex/webaxapi",

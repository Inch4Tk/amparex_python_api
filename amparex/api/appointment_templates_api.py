...
class AppointmentTemplatesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.search_appointment_templates_using_post_endpoint = _Endpoint(
            settings={
                'response_type': (ListResultWrapperAppointmentTemplate,),
                'auth': [
                    'security_token'
                ],
                'endpoint_path': '/alias/{alias}/protected/appointmenttemplates/search',
                'operation_id': 'search_appointment_templates_using_post',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def search_appointment_templates_using_post(
        self,
        alias,
        search_query,
        **kwargs
    ):
        """Get a list of appointment templates  # noqa: E501

        Get a list of templates for online booking by branch-id  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.search_appointment_templates_using_post(alias, search_query, async_req=True)
        >>> result = thread.get()

        Args:
            alias (str): alias
            search_query (AppointmentTemplateSearchQuery): searchQuery
        ...
        kwargs['search_query'] = \
            search_query
        return self.search_appointment_templates_using_post_endpoint.call_with_http_info(**kwargs)

...
class BrandsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_brand_image_using_get_endpoint = _Endpoint(
            settings={
                'response_type': (str,),
                'auth': [
                    'security_token'
                ],
                'endpoint_path': '/alias/{alias}/protected/brands/{brandid}/images/{imageid}',
                'operation_id': 'get_brand_image_using_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_brand_using_get_endpoint = _Endpoint(
            settings={
                'response_type': (Brand,),
                'auth': [
                    'security_token'
                ],
                'endpoint_path': '/alias/{alias}/protected/brands/{id}',
                'operation_id': 'get_brand_using_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.search_brands_using_post_endpoint = _Endpoint(
            settings={
                'response_type': (ListResultWrapperBrand,),
                'auth': [
                    'security_token'
                ],
                'endpoint_path': '/alias/{alias}/protected/brands/search',
                'operation_id': 'search_brands_using_post',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def get_brand_image_using_get(
        ...
        **kwargs
        ...
        """Get image of brand as blob  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_brand_image_using_get(alias, brandid, imageid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['imageid'] = \
            imageid
        return self.get_brand_image_using_get_endpoint.call_with_http_info(**kwargs)

    def get_brand_using_get(
        self,
        alias,
        id,
        **kwargs
    ):
        """Get one specific brand by id  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_brand_using_get(alias, id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['id'] = \
            id
        return self.get_brand_using_get_endpoint.call_with_http_info(**kwargs)

    def search_brands_using_post(
        self,
        alias,
        search_query,
        **kwargs
    ):
        """Get a list of brands  # noqa: E501

        Get a list of brands by a search query, paging is used, specify limit and page; Model Type: Brand is returned  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.search_brands_using_post(alias, search_query, async_req=True)
        >>> result = thread.get()

        Args:
            alias (str): alias
            search_query (BrandSearchQuery): searchQuery
        ...
        kwargs['search_query'] = \
            search_query
        return self.search_brands_using_post_endpoint.call_with_http_info(**kwargs)

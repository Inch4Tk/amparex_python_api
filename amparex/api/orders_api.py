...
class OrdersApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_order_using_get_endpoint = _Endpoint(
            settings={
                'response_type': (Order,),
                'auth': [
                    'security_token'
                ],
                'endpoint_path': '/alias/{alias}/protected/orders/{id}',
                'operation_id': 'get_order_using_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.search_orders_using_post_endpoint = _Endpoint(
            settings={
                'response_type': (ListResultWrapperOrder,),
                'auth': [
                    'security_token'
                ],
                'endpoint_path': '/alias/{alias}/protected/orders/search',
                'operation_id': 'search_orders_using_post',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def get_order_using_get(
        self,
        alias,
        id,
        **kwargs
    ):
        """Get one specific order by id  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_order_using_get(alias, id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['id'] = \
            id
        return self.get_order_using_get_endpoint.call_with_http_info(**kwargs)

    def search_orders_using_post(
        self,
        alias,
        order_search_query,
        **kwargs
        ...
        Get a list of orders  by a search query, paging is used, specify limit and page; Model Type: Order is returned  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.search_orders_using_post(alias, order_search_query, async_req=True)
        >>> result = thread.get()

        Args:
            alias (str): alias
            order_search_query (OrderSearchQuery): orderSearchQuery
        ...
        kwargs['alias'] = \
            alias
        kwargs['order_search_query'] = \
            order_search_query
        return self.search_orders_using_post_endpoint.call_with_http_info(**kwargs)

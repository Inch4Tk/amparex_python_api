...
class ProgramsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.search_program_moves_using_post_endpoint = _Endpoint(
            settings={
                'response_type': (ListResultWrapperProgramMove,),
                'auth': [
                    'security_token'
                ],
                'endpoint_path': '/alias/{alias}/protected/programmoves/search',
                'operation_id': 'search_program_moves_using_post',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def search_program_moves_using_post(
        self,
        alias,
        move_search_query,
        **kwargs
    ):
        """Get a list of program moves  # noqa: E501

        Get a list of program moves by a search query, paging is used, specify limit and page; Model Type: ProgramMove is returned  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.search_program_moves_using_post(alias, move_search_query, async_req=True)
        >>> result = thread.get()

        Args:
            alias (str): alias
            move_search_query (ProgramMoveSearchQuery): moveSearchQuery
        ...
        kwargs['alias'] = \
            alias
        kwargs['move_search_query'] = \
            move_search_query
        return self.search_program_moves_using_post_endpoint.call_with_http_info(**kwargs)

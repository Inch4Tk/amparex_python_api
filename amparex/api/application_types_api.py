...
class ApplicationTypesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.find_all_app_types_using_get_endpoint = _Endpoint(
            settings={
                'response_type': ([ApplicationType],),
                'auth': [
                    'security_token'
                ],
                'endpoint_path': '/alias/{alias}/protected/applicationtypes',
                'operation_id': 'find_all_app_types_using_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def find_all_app_types_using_get(
        self,
        alias,
        **kwargs
    ):
        """Get possible values for application type  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.find_all_app_types_using_get(alias, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['alias'] = \
            alias
        return self.find_all_app_types_using_get_endpoint.call_with_http_info(**kwargs)

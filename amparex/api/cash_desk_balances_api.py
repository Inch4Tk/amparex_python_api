...
class CashDeskBalancesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_cash_desk_balance_using_get_endpoint = _Endpoint(
            settings={
                'response_type': (ApiCashDeskBalance,),
                'auth': [
                    'security_token'
                ],
                'endpoint_path': '/alias/{alias}/protected/cashdeskbalances/{id}',
                'operation_id': 'get_cash_desk_balance_using_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.search_cash_desk_balances_using_post_endpoint = _Endpoint(
            settings={
                'response_type': (ListResultWrapperApiCashDeskBalance,),
                'auth': [
                    'security_token'
                ],
                'endpoint_path': '/alias/{alias}/protected/cashdeskbalances/search',
                'operation_id': 'search_cash_desk_balances_using_post',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    'alias': 'path',
                    'cashdeskbalance_search_query': 'body',
                },
                'collection_format_map': {
                }
            },
    ...
    def get_cash_desk_balance_using_get(
        self,
        alias,
        id,
        **kwargs
    ):
        """Get one specific cashdeskbalance by id  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_cash_desk_balance_using_get(alias, id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['id'] = \
            id
        return self.get_cash_desk_balance_using_get_endpoint.call_with_http_info(**kwargs)

    def search_cash_desk_balances_using_post(
        self,
        alias,
        cashdeskbalance_search_query,
        **kwargs
    ):
        """Get a list of cashdeskbalances  # noqa: E501

        Get a list of cashdeskbalances  by a search query, paging is used, specify limit and page; Model Type: CashDeskBalance is returned  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.search_cash_desk_balances_using_post(alias, cashdeskbalance_search_query, async_req=True)
        >>> result = thread.get()

        Args:
            alias (str): alias
            cashdeskbalance_search_query (ApiCashDeskBalanceSearchQuery): cashdeskbalanceSearchQuery
        ...
        Returns:
            ListResultWrapperApiCashDeskBalance
                If the method is called asynchronously, returns the request
                thread.
        """
        kwargs['async_req'] = kwargs.get(
        ...
        kwargs['alias'] = \
            alias
        kwargs['cashdeskbalance_search_query'] = \
            cashdeskbalance_search_query
        return self.search_cash_desk_balances_using_post_endpoint.call_with_http_info(**kwargs)

...
class ServersApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_server_using_get_endpoint = _Endpoint(
            settings={
                'response_type': (Server,),
                'auth': [
                    'security_token'
                ],
                'endpoint_path': '/alias/{alias}/protected/servers/{id}',
                'operation_id': 'get_server_using_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.search_servers_using_post_endpoint = _Endpoint(
            settings={
                'response_type': (ListResultWrapperServer,),
                'auth': [
                    'security_token'
                ],
                'endpoint_path': '/alias/{alias}/protected/servers/search',
                'operation_id': 'search_servers_using_post',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def get_server_using_get(
        self,
        alias,
        id,
        **kwargs
    ):
        """Get one specific server by id  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_server_using_get(alias, id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['id'] = \
            id
        return self.get_server_using_get_endpoint.call_with_http_info(**kwargs)

    def search_servers_using_post(
        self,
        alias,
        server_search_query,
        **kwargs
    ):
        """Get a list of servers  # noqa: E501

        Get a list of servers  by a search query, paging is used, specify limit and page; Model Type: Server is returned  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.search_servers_using_post(alias, server_search_query, async_req=True)
        >>> result = thread.get()

        Args:
            alias (str): alias
            server_search_query (ServerSearchQuery): serverSearchQuery
        ...
        kwargs['alias'] = \
            alias
        kwargs['server_search_query'] = \
            server_search_query
        return self.search_servers_using_post_endpoint.call_with_http_info(**kwargs)

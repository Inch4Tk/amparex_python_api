...
class CompaniesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_company_using_get_endpoint = _Endpoint(
            settings={
                'response_type': (Company,),
                'auth': [
                    'security_token'
                ],
                'endpoint_path': '/alias/{alias}/protected/companies/{id}',
                'operation_id': 'get_company_using_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.search_companies_using_post_endpoint = _Endpoint(
            settings={
                'response_type': (ListResultWrapperCompany,),
                'auth': [
                    'security_token'
                ],
                'endpoint_path': '/alias/{alias}/protected/companies/search',
                'operation_id': 'search_companies_using_post',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def get_company_using_get(
        self,
        alias,
        id,
        **kwargs
    ):
        """Get one specific company by id  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_company_using_get(alias, id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['id'] = \
            id
        return self.get_company_using_get_endpoint.call_with_http_info(**kwargs)

    def search_companies_using_post(
        self,
        alias,
        search_query,
        **kwargs
    ):
        """Get a list of companies  # noqa: E501

        Get a list of companies by a search query, paging is used, specify limit and page; Model Type: Company is returned  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.search_companies_using_post(alias, search_query, async_req=True)
        >>> result = thread.get()

        Args:
            alias (str): alias
            search_query (CompanySearchQuery): searchQuery
        ...
        kwargs['search_query'] = \
            search_query
        return self.search_companies_using_post_endpoint.call_with_http_info(**kwargs)

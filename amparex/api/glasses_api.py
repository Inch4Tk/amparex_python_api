...
class GlassesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_glasses_using_get_endpoint = _Endpoint(
            settings={
                'response_type': (GlassesCare,),
                'auth': [
                    'security_token'
                ],
                'endpoint_path': '/alias/{alias}/protected/glasses/{id}',
                'operation_id': 'get_glasses_using_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.search_glassess_using_post_endpoint = _Endpoint(
            settings={
                'response_type': (ListResultWrapperGlassesCare,),
                'auth': [
                    'security_token'
                ],
                'endpoint_path': '/alias/{alias}/protected/glasses/search',
                'operation_id': 'search_glassess_using_post',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def get_glasses_using_get(
        self,
        alias,
        id,
        **kwargs
    ):
        """Get one specific glasses by id  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_glasses_using_get(alias, id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['id'] = \
            id
        return self.get_glasses_using_get_endpoint.call_with_http_info(**kwargs)

    def search_glassess_using_post(
        self,
        alias,
        glasses_search_query,
        **kwargs
    ):
        """Get a list of glasses  # noqa: E501

        Get a list of glasses  by a search query, paging is used, specify limit and page; Model Type: Glasses is returned  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.search_glassess_using_post(alias, glasses_search_query, async_req=True)
        >>> result = thread.get()

        Args:
            alias (str): alias
            glasses_search_query (GlassesSearchQuery): glassesSearchQuery
        ...
        kwargs['alias'] = \
            alias
        kwargs['glasses_search_query'] = \
            glasses_search_query
        return self.search_glassess_using_post_endpoint.call_with_http_info(**kwargs)

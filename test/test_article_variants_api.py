...
class TestArticleVariantsApi(unittest.TestCase):
    """ArticleVariantsApi unit test stubs"""

    def setUp(self):
        self.api = ArticleVariantsApi()  # noqa: E501

    def tearDown(self):
        pass

    def test_get_article_variant_using_get(self):
        """Test case for get_article_variant_using_get

        Get one specific article variant by id  # noqa: E501
        """
        pass

    def test_search_article_variants_using_post(self):
        """Test case for search_article_variants_using_post

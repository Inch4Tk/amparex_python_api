...
class TestCashDeskBalancesApi(unittest.TestCase):
    """CashDeskBalancesApi unit test stubs"""

    def setUp(self):
        self.api = CashDeskBalancesApi()  # noqa: E501

    def tearDown(self):
        pass

    def test_get_cash_desk_balance_using_get(self):
        """Test case for get_cash_desk_balance_using_get

        Get one specific cashdeskbalance by id  # noqa: E501
        """
        pass

    def test_search_cash_desk_balances_using_post(self):
        """Test case for search_cash_desk_balances_using_post

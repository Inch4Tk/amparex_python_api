...
class TestInvoicesApi(unittest.TestCase):
    ...
    def test_payment_references_using_get(self):
        """Test case for payment_references_using_get

        Get a list of payment references for a given invoice  # noqa: E501
        """
        pass

    def test_search_invoices_using_post(self):
        """Test case for search_invoices_using_post

...
class TreatmentsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_sales_order_using_post_endpoint = _Endpoint(
            settings={
                'response_type': (TreatmentCreationResponse,),
                'auth': [
                    'security_token'
                ],
                'endpoint_path': '/alias/{alias}/protected/treatments/salesorder',
                'operation_id': 'create_sales_order_using_post',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.get_doctor_for_treatment_using_get_endpoint = _Endpoint(
            settings={
                'response_type': (Doctor,),
                'auth': [
                    'security_token'
                ],
                'endpoint_path': '/alias/{alias}/protected/treatments/{id}/doctors',
                'operation_id': 'get_doctor_for_treatment_using_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_therapeutics_treatment_using_get_endpoint = _Endpoint(
            settings={
                'response_type': (TherapeuticsTreatment,),
                'auth': [
                    'security_token'
                ],
                'endpoint_path': '/alias/{alias}/protected/treatments/therapeutics/{id}',
                'operation_id': 'get_therapeutics_treatment_using_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_treatment_invoices_using_get_endpoint = _Endpoint(
            settings={
                'response_type': (ListResultWrapperInvoice,),
                'auth': [
                    'security_token'
                ],
                'endpoint_path': '/alias/{alias}/protected/treatments/{id}/invoices',
                'operation_id': 'get_treatment_invoices_using_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_treatment_using_get_endpoint = _Endpoint(
            settings={
                'response_type': (Treatment,),
                'auth': [
                    'security_token'
                ],
                'endpoint_path': '/alias/{alias}/protected/treatments/{id}',
                'operation_id': 'get_treatment_using_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.search_treatments_using_post_endpoint = _Endpoint(
            settings={
                'response_type': (ListResultWrapperTreatment,),
                'auth': [
                    'security_token'
                ],
                'endpoint_path': '/alias/{alias}/protected/treatments/search',
                'operation_id': 'search_treatments_using_post',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def create_sales_order_using_post(
        self,
        alias,
        to_save,
        **kwargs
        ...
        >>> thread = api.create_sales_order_using_post(alias, to_save, async_req=True)
        >>> result = thread.get()

        Args:
            alias (str): alias
            to_save (SalesTreatmentToCreate): toSave
        ...
        kwargs['to_save'] = \
            to_save
        return self.create_sales_order_using_post_endpoint.call_with_http_info(**kwargs)

    def get_doctor_for_treatment_using_get(
        self,
        alias,
        id,
        **kwargs
        ...
        >>> thread = api.get_doctor_for_treatment_using_get(alias, id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['id'] = \
            id
        return self.get_doctor_for_treatment_using_get_endpoint.call_with_http_info(**kwargs)
    ...
    def get_therapeutics_treatment_using_get(
        self,
        alias,
        id,
        **kwargs
        ...
        >>> thread = api.get_therapeutics_treatment_using_get(alias, id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['id'] = \
            id
        return self.get_therapeutics_treatment_using_get_endpoint.call_with_http_info(**kwargs)

    def get_treatment_invoices_using_get(
        self,
        alias,
        id,
        **kwargs
        ...
        >>> thread = api.get_treatment_invoices_using_get(alias, id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['id'] = \
            id
        return self.get_treatment_invoices_using_get_endpoint.call_with_http_info(**kwargs)

    def get_treatment_using_get(
        self,
        alias,
        id,
        **kwargs
        ...
        >>> thread = api.get_treatment_using_get(alias, id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['id'] = \
            id
        return self.get_treatment_using_get_endpoint.call_with_http_info(**kwargs)
    ...
    def search_treatments_using_post(
        self,
        alias,
        treatment_search_query,
        **kwargs
        ...
        Get a list of treatments by a search query, paging is used, specify limit and page; Model Type: Treatment is returned  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.search_treatments_using_post(alias, treatment_search_query, async_req=True)
        >>> result = thread.get()

        Args:
            alias (str): alias
            treatment_search_query (TreatmentSearchQuery): treatmentSearchQuery
        ...
        kwargs['alias'] = \
            alias
        kwargs['treatment_search_query'] = \
            treatment_search_query
        return self.search_treatments_using_post_endpoint.call_with_http_info(**kwargs)

...
class ColorsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_color_using_get_endpoint = _Endpoint(
            settings={
                'response_type': (Color,),
                'auth': [
                    'security_token'
                ],
                'endpoint_path': '/alias/{alias}/protected/colors/{id}',
                'operation_id': 'get_color_using_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.search_colors_using_post_endpoint = _Endpoint(
            settings={
                'response_type': (ListResultWrapperColor,),
                'auth': [
                    'security_token'
                ],
                'endpoint_path': '/alias/{alias}/protected/colors/search',
                'operation_id': 'search_colors_using_post',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def get_color_using_get(
        self,
        alias,
        id,
        **kwargs
    ):
        """Get one specific color by id  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_color_using_get(alias, id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['id'] = \
            id
        return self.get_color_using_get_endpoint.call_with_http_info(**kwargs)

    def search_colors_using_post(
        self,
        alias,
        search_query,
        **kwargs
    ):
        """Get a list of colors  # noqa: E501

        Get a list of colors by a search query, paging is used, specify limit and page; Model Type: Color is returned  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.search_colors_using_post(alias, search_query, async_req=True)
        >>> result = thread.get()

        Args:
            alias (str): alias
            search_query (ColorSearchQuery): searchQuery
        ...
        kwargs['search_query'] = \
            search_query
        return self.search_colors_using_post_endpoint.call_with_http_info(**kwargs)

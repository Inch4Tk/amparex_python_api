...
class ArticleVariantsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_article_variant_using_get_endpoint = _Endpoint(
            settings={
                'response_type': (ArticleVariant,),
                'auth': [
                    'security_token'
                ],
                'endpoint_path': '/alias/{alias}/protected/articlevariants/{id}',
                'operation_id': 'get_article_variant_using_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.search_article_variants_using_post_endpoint = _Endpoint(
            settings={
                'response_type': (ListResultWrapperArticleVariant,),
                'auth': [
                    'security_token'
                ],
                'endpoint_path': '/alias/{alias}/protected/articlevariants/search',
                'operation_id': 'search_article_variants_using_post',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    'alias': 'path',
                    'articlevariant_search_query': 'body',
                },
                'collection_format_map': {
                }
            },
    ...
    def get_article_variant_using_get(
        self,
        alias,
        id,
        **kwargs
    ):
        """Get one specific article variant by id  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_article_variant_using_get(alias, id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['id'] = \
            id
        return self.get_article_variant_using_get_endpoint.call_with_http_info(**kwargs)

    def search_article_variants_using_post(
        self,
        alias,
        articlevariant_search_query,
        **kwargs
    ):
        """Get a list of article variants  # noqa: E501

        Get a list of article variants  by a search query, paging is used, specify limit and page; Model Type: ArticleVariant is returned  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.search_article_variants_using_post(alias, articlevariant_search_query, async_req=True)
        >>> result = thread.get()

        Args:
            alias (str): alias
            articlevariant_search_query (ArticleVariantSearchQuery): articlevariantSearchQuery
        ...
        kwargs['alias'] = \
            alias
        kwargs['articlevariant_search_query'] = \
            articlevariant_search_query
        return self.search_article_variants_using_post_endpoint.call_with_http_info(**kwargs)

...
class SurveysApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_survey_using_get_endpoint = _Endpoint(
            settings={
                'response_type': (Survey,),
                'auth': [
                    'security_token'
                ],
                'endpoint_path': '/alias/{alias}/protected/surveys/{id}',
                'operation_id': 'get_survey_using_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.search_surveys_using_post_endpoint = _Endpoint(
            settings={
                'response_type': (ListResultWrapperSurvey,),
                'auth': [
                    'security_token'
                ],
                'endpoint_path': '/alias/{alias}/protected/surveys/search',
                'operation_id': 'search_surveys_using_post',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def get_survey_using_get(
        ...
        **kwargs
        ...
        >>> thread = api.get_survey_using_get(alias, id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['id'] = \
            id
        return self.get_survey_using_get_endpoint.call_with_http_info(**kwargs)

    def search_surveys_using_post(
        self,
        alias,
        survey_search_query,
        **kwargs
        ...
        Get a list of surveys  by a search query, paging is used, specify limit and page; Model Type: Survey is returned  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.search_surveys_using_post(alias, survey_search_query, async_req=True)
        >>> result = thread.get()

        Args:
            alias (str): alias
            survey_search_query (SurveySearchQuery): surveySearchQuery
        ...
        kwargs['alias'] = \
            alias
        kwargs['survey_search_query'] = \
            survey_search_query
        return self.search_surveys_using_post_endpoint.call_with_http_info(**kwargs)

...
class DocumentTemplatesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.search_document_templates_using_post_endpoint = _Endpoint(
            settings={
                'response_type': (ListResultWrapperDocumentTemplate,),
                'auth': [
                    'security_token'
                ],
                'endpoint_path': '/alias/{alias}/protected/documnettemplates/search',
                'operation_id': 'search_document_templates_using_post',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def search_document_templates_using_post(
        self,
        alias,
        search_query,
        **kwargs
    ):
        """Get a list of document templates  # noqa: E501

        Get a list of document templates by a search query, paging is used, specify limit and page; Model Type: DocumentTemplate is returned  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.search_document_templates_using_post(alias, search_query, async_req=True)
        >>> result = thread.get()

        Args:
            alias (str): alias
            search_query (DocumentTemplateSearchQuery): searchQuery
        ...
        kwargs['search_query'] = \
            search_query
        return self.search_document_templates_using_post_endpoint.call_with_http_info(**kwargs)

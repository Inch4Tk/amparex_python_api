...
class MainVersionSearchQuery(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """MainVersionSearchQuery - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            end_date_from (date): Searches all main versions that are build after given end date. [optional]  # noqa: E501
            end_date_to (date): Searches all main versions that are build before given end date. [optional]  # noqa: E501
            meta_data (SearchQueryMetaData): [optional]  # noqa: E501
            number (str): Searches by using main version number. e.g. \"LTS-2020.4\". [optional]  # noqa: E501
            order_by ([OrderBy]): Multiple order by criteria, use mainversion/orderByFields to get possible values. Use \"ASC\" for ascending, \"DESC\" for descending order; default is \"ASC\". Maximum 3 order criteria are used.. [optional]  # noqa: E501
            start_date_from (date): Searches all main versions that are build after given start date. [optional]  # noqa: E501
            start_date_to (date): Searches all main versions that are build before given start date. [optional]  # noqa: E501
            status (str): Searches all main versions for specific status. [optional]  # noqa: E501
        """

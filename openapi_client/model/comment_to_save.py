...
class CommentToSave(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'publish_branch_id': (str,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'publish_branch_id': 'publishBranchID',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """CommentToSave - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            date (str): Creation date of the comment, if empty current date will be used. [optional]  # noqa: E501
            note (str): The text of the comment, if empty comment will not be saved. [optional]  # noqa: E501
            person_id (str): This is the owner of the comment, use customerID here. [optional]  # noqa: E501
            publish_branch_id (str): Related branch of the comment, if empty current branch is used. [optional]  # noqa: E501
            staff_id (str): Staff which creates the comment, use id of staff here, if empty current staff will be used. [optional]  # noqa: E501
            treatment_head_id (str): Connected treatment, could be empty. [optional]  # noqa: E501
            type_id (str): Type of the comment, use id of predefined property here, if empty type note is used. [optional]  # noqa: E501
        """
